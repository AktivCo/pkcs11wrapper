...
public final class FakeConstants {
    public final static String PEM_CERTIFICATE_RSA = "-----BEGIN CERTIFICATE-----\n" +
    ...
    public final static String PEM_CERTIFICATE_GOSTR_2012_256 = "-----BEGIN CERTIFICATE-----\n" +
