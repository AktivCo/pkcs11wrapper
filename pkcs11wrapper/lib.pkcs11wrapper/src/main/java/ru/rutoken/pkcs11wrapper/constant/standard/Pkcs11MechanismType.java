...
public enum Pkcs11MechanismType implements IPkcs11MechanismType {
    ...
    CKM_RSA_PKCS_PSS(0x0000000DL), // CkRsaPkcsPssParams
    CKM_SHA1_RSA_PKCS_PSS(0x0000000EL), // CkRsaPkcsPssParams
    ...
    CKM_DH_PKCS_DERIVE(0x00000021L), // Pkcs11ByteArrayMechanismParams
    ...
    CKM_SHA256_RSA_PKCS(0x00000040L),
    CKM_SHA384_RSA_PKCS(0x00000041L),
    CKM_SHA512_RSA_PKCS(0x00000042L),
    CKM_SHA256_RSA_PKCS_PSS(0x00000043L), // CkRsaPkcsPssParams
    CKM_SHA384_RSA_PKCS_PSS(0x00000044L), // CkRsaPkcsPssParams
    CKM_SHA512_RSA_PKCS_PSS(0x00000045L), // CkRsaPkcsPssParams

    CKM_SHA224_RSA_PKCS(0x00000046L),
    CKM_SHA224_RSA_PKCS_PSS(0x00000047L), // CkRsaPkcsPssParams
    ...
    CKM_GOSTR3410_WITH_GOSTR3411(0x00001202L), // Pkcs11ByteArrayMechanismParams
    CKM_GOSTR3410_KEY_WRAP(0x00001203L), // CkGostR3410KeyWrapParams
    CKM_GOSTR3410_DERIVE(0x00001204L), // CkGostR3410DeriveParams
    CKM_GOSTR3411(0x00001210L), // Pkcs11ByteArrayMechanismParams
    CKM_GOSTR3411_HMAC(0x00001211L), // Pkcs11ByteArrayMechanismParams
    CKM_GOST28147_KEY_GEN(0x00001220L),
    CKM_GOST28147_ECB(0x00001221L),
    CKM_GOST28147(0x00001222L), // Pkcs11ByteArrayMechanismParams
    CKM_GOST28147_MAC(0x00001223L), // Pkcs11ByteArrayMechanismParams
    CKM_GOST28147_KEY_WRAP(0x00001224L), // Pkcs11ByteArrayMechanismParams

    CKM_DSA_PARAMETER_GEN(0x00002000L),
    CKM_DH_PKCS_PARAMETER_GEN(0x00002001L),
    CKM_X9_42_DH_PKCS_PARAMETER_GEN(0x00002002L),
    ...
    /**
     * @deprecated CKM_CAST128_CBC is preferred.
     */
    @Deprecated
    public static final Pkcs11MechanismType CKM_CAST5_CBC = CKM_CAST128_CBC;
    /**
     * @deprecated CKM_CAST128_MAC is preferred.
     */
    @Deprecated
    public static final Pkcs11MechanismType CKM_CAST5_MAC = CKM_CAST128_MAC;
    /**
     * @deprecated CKM_CAST128_MAC_GENERAL is preferred.
     */
    @Deprecated
    public static final Pkcs11MechanismType CKM_CAST5_MAC_GENERAL = CKM_CAST128_MAC_GENERAL;
    /**
     * @deprecated CKM_CAST128_CBC_PAD is preferred.
     */
    @Deprecated
    public static final Pkcs11MechanismType CKM_CAST5_CBC_PAD = CKM_CAST128_CBC_PAD;
    /**
     * @deprecated CKM_PBE_MD5_CAST128_CBC is preferred.
     */
    @Deprecated
    public static final Pkcs11MechanismType CKM_PBE_MD5_CAST5_CBC = CKM_PBE_MD5_CAST128_CBC;
    /**
     * @deprecated CKM_PBE_SHA1_CAST128_CBC is preferred.
     */
    @Deprecated
    public static final Pkcs11MechanismType CKM_PBE_SHA1_CAST5_CBC = CKM_PBE_SHA1_CAST128_CBC;
    /**
     * @deprecated CKM_EC_KEY_PAIR_GEN is preferred.
     */
    @Deprecated
    public static final Pkcs11MechanismType CKM_ECDSA_KEY_PAIR_GEN = CKM_EC_KEY_PAIR_GEN;

    private static final EnumFromValueHelper<Pkcs11MechanismType> FROM_VALUE_HELPER = new EnumFromValueHelper<>();
    ...
    @Nullable
    public static Pkcs11MechanismType nullableFromValue(long value) {
        return FROM_VALUE_HELPER.nullableFromValue(value, Pkcs11MechanismType.class);
    }

    public static Pkcs11MechanismType fromValue(long value) {
        return FROM_VALUE_HELPER.fromValue(value, Pkcs11MechanismType.class);
    }
