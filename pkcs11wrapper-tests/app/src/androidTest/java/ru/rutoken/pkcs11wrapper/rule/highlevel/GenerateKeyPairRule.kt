...
/**
 * @param beforeGenerationCheck function that is executed before key pair generation. If this function returns false,
 *                              tests that used this rule will be halted and ignored.
 */
